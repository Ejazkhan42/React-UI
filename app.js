...
//   }
// });
// app.get('/api/jobInfo', async (req, res) => {
//   try {
...
// app.get("/api/getbycustomer", async (req, res) => {
...
// app.post("/api/customerupdate", async (req, res) => {
...
// app.post('/api/postlogs', async (req, res) => {
...
//   }
// });
// app.get("/api/getflow", async (req, res) => {
...
// });
// // DELETE USER BY ID SECTION *
// app.post("/api/deletenv", async (req, res) => {
...
// app.post("/api/newenv", async (req, res) => {
...
// app.post("/api/reportslogs", async (req,res)=>{
...
// app.post("/api/postbrowser-id", async (req,res)=>{
//   browser = req.body;
//   console.log('Received browser ID:', browser);
//   res.send('Browser ID received successfully');
// })
// app.get("/api/getbrowser-id",async(req,res)=>{
//   res.send(browser)
// })
// app.post("/api/updateenv", async (req, res) => {
//   const envDetails = req.body.envDetails;
